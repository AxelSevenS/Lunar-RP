...
namespace LunarRenderPipeline {
    ...
    /// </summary>
    /// <seealso cref="LunarRenderer"/>
    /// <seealso cref="LunarRenderPass"/>
    [ExcludeFromPreset]
    public abstract class LunarRendererFeature : ScriptableObject, IDisposable {

        [SerializeField, HideInInspector] private bool m_Active = true;
        /// <summary>
        /// Returns the state of the LunarRenderFeature (true: the feature is active, false: the feature is inactive). Use the method LunarRenderFeature.SetActive to change the value of this variable.
        /// </summary>
        ...
        /// <summary>
        /// Injects one or multiple <c>LunarRenderPass</c> in the renderer.
        /// </summary>
        /// <param name="renderer">Renderer used for adding render passes.</param>
        /// <param name="renderingData">Rendering state. Use this to setup render passes.</param>
        public abstract void AddRenderPasses(LunarRenderer renderer, ref RenderingData renderingData);
        ...
        /// <param name="renderer">Renderer used for adding render passes.</param>
        /// <param name="renderingData">Rendering state. Use this to setup render passes.</param>
        public virtual void SetupRenderPasses(LunarRenderer renderer, in RenderingData renderingData) { }
        ...
        /// <summary>
        /// Sets the state of LunarRenderFeature (true: the feature is active, false: the feature is inactive).
        /// If the feature is active, it is added to the renderer it is attached to, otherwise the feature is skipped while rendering.
        /// </summary>
        /// <param name="active">The true value activates the LunarRenderFeature and the false value deactivates it.</param>
