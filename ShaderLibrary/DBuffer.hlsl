#ifndef LUNAR_DBUFFER_INCLUDED
#define LUNAR_DBUFFER_INCLUDED
...
#include "Packages/com.seven.lunar-render-pipeline/ShaderLibrary/Input/DecalInput.hlsl"
...
#endif
#if defined(_DBUFFER_MRT3)
    outDBuffer2 = half4(0/* surfaceData.metallic */, surfaceData.occlusion, surfaceData.smoothness, surfaceData.MAOSAlpha);
#endif
}
