...
Light GetMainLight() {
    // unity_LightData = half4(1, 1, 1, 0); // Where do I set this in the code?
...
// #if USE_FORWARD_PLUS
    ...
    #endif
// #else
//     light.distanceAttenuation = 1/* unity_LightData.z */; // unity_LightData.z is 1 when not culled by the culling mask, otherwise 0.
// #endif
...
//     #if USE_STRUCTURED_BUFFER_FOR_LIGHT_DATA
//         return uint(1/* unity_LightData.x */);
//     #else
//         return 0;
//     #endif
// }
...
//     /////////////////////////////////////////////////////////////////////////////////////////////
//     #if USE_STRUCTURED_BUFFER_FOR_LIGHT_DATA
//         uint offset = uint(1/* unity_LightData.x */);
